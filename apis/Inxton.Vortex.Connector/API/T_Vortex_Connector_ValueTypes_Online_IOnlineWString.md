...
Defines contract to access online value of <a href="https://docs.microsoft.com/dotnet/api/system.string" target="_blank">String</a>; WSTRING type of the PLC.
...
The IOnlineWString type exposes the following members.
...
<a href="#ionlinewstring-interface">Back to Top</a>
