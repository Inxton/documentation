...
Defines contract to access online value of <a href="https://docs.microsoft.com/dotnet/api/system.uint64" target="_blank">UInt64</a>; ULINT type of the PLC.
...
The IOnlineULInt type exposes the following members.
...
<a href="#ionlineulint-interface">Back to Top</a>
