...
**C#**<br />
``` C#
public class OnlinerWString : OnlinerBaseType<string>, 
	IOnlineWString, IOnline<string>, IShadowWString, IShadow<string>
```

The OnlinerWString type exposes the following members.
...
Initializes a new instance of the OnlinerWString class.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Connector_ValueTypes_OnlinerWString__ctor_1.md">OnlinerWString(IVortexObject, String, String)</a></td><td>
Initializes a new instance of the OnlinerWString class.</td></tr></table>&nbsp;
<a href="#onlinerwstring-class">Back to Top</a>
...
Gets or sets the attribute units.
 (Inherited from <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType_1.md">OnlinerBaseType(T)</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerWString_Cyclic.md">Cyclic</a></td><td>
Gets tranlated and interpolated string of <a href="P_Vortex_Connector_ValueTypes_OnlinerWString_Cyclic.md">Cyclic</a> value. Sets <a href="P_Vortex_Connector_ValueTypes_OnlinerWString_Cyclic.md">Cyclic</a> value.
...
Provides a string combined from <a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_AttributeName.md">AttributeName</a> of ancestors (<a href="M_Vortex_Connector_ValueTypes_OnlinerBaseType_1_GetParent.md">GetParent()</a>) of this instance and the tail of this instance.
 (Inherited from <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType_1.md">OnlinerBaseType(T)</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerWString_InstanceMaxValue.md">InstanceMaxValue</a></td><td>
Gets the max value for this instance.
 (Overrides <a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_InstanceMaxValue.md">OnlinerBaseType(T).InstanceMaxValue</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerWString_InstanceMinValue.md">InstanceMinValue</a></td><td>
...
Gets or sets the tail of the symbol of this tag.
 (Inherited from <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType_1.md">OnlinerBaseType(T)</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerWString_Synchron.md">Synchron</a></td><td>
Gets tranlated and interpolated string of <a href="P_Vortex_Connector_ValueTypes_OnlinerWString_Synchron.md">Synchron</a> value. Sets <a href="P_Vortex_Connector_ValueTypes_OnlinerWString_Synchron.md">Synchron</a> value.
