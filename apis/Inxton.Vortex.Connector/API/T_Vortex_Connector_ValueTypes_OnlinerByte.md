...
**C#**<br />
``` C#
public class OnlinerByte : OnlinerBaseType<byte>, 
	IOnlineByte, IOnline<byte>, IShadowByte, IShadow<byte>
```

The OnlinerByte type exposes the following members.
...
Initializes a new instance of the OnlinerByte class.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Connector_ValueTypes_OnlinerByte__ctor_1.md">OnlinerByte(IVortexObject, String, String)</a></td><td>
Initializes a new instance of the OnlinerByte class.</td></tr></table>&nbsp;
<a href="#onlinerbyte-class">Back to Top</a>
...
Gets the max value of OnlinerByte.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")![Static member](media/static.gif "Static member")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerByte_MinValue.md">MinValue</a></td><td>
Gets the min value of OnlinerByte.</td></tr><tr><td>![Protected property](media/protproperty.gif "Protected property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_Parent.md">Parent</a></td><td>
