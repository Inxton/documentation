# TypeMetaDescriptorAttribute Class
 

Provides meta information about Plc controller type for the library compilation process.
&nbsp;<table><tr><th>![Note](media/AlertNote.png) Note</th></tr><tr><td>This attribute is not applicable in framework consumers code. It serves a purpose of providing information about the library metadata.</td></tr></table>

## Inheritance Hierarchy
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="https://docs.microsoft.com/dotnet/api/system.attribute" target="_blank">System.Attribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Vortex.Connector.Attributes.TypeMetaDescriptorAttribute<br />
...
**C#**<br />
``` C#
public class TypeMetaDescriptorAttribute : Attribute
```

The TypeMetaDescriptorAttribute type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Connector_Attributes_TypeMetaDescriptorAttribute__ctor.md">TypeMetaDescriptorAttribute</a></td><td>
Creates new instance of TypeMetaDescriptorAttribute</td></tr></table>&nbsp;
<a href="#typemetadescriptorattribute-class">Back to Top</a>
...
Gets the metadata for this type.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="https://docs.microsoft.com/dotnet/api/system.attribute.typeid#System_Attribute_TypeId" target="_blank">TypeId</a></td><td>
