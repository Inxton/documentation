...
Defines contract to access online value of <a href="https://docs.microsoft.com/dotnet/api/system.double" target="_blank">Double</a>; LREAL type of the PLC.
...
The IOnlineLReal type exposes the following members.
...
<a href="#ionlinelreal-interface">Back to Top</a>
