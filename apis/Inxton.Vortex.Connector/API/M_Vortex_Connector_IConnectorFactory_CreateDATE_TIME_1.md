# IConnectorFactory.CreateDATE_TIME Method (IVortexObject, String, String)
 

Creates <a href="https://docs.microsoft.com/dotnet/api/system.datetime" target="_blank">DateTime</a> tag of a value type DT, DATE_TIME;
...
**C#**<br />
``` C#
public abstract OnlinerDateTime CreateDATE_TIME(
