...
Defines contract to access shadow value of <a href="https://docs.microsoft.com/dotnet/api/system.string" target="_blank">String</a>; STRING type of the PLC.
...
The IShadowString type exposes the following members.
...
<a href="#ishadowstring-interface">Back to Top</a>
