...
**C#**<br />
``` C#
public class OnlinerBool : OnlinerBaseType<bool>, 
	IOnlineBool, IOnline<bool>, IShadowBool, IShadow<bool>
```

The OnlinerBool type exposes the following members.
...
Creates new instance of OnlinerBool class.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Connector_ValueTypes_OnlinerBool__ctor_1.md">OnlinerBool(IVortexObject, String, String)</a></td><td>
Initializes a new instance of the OnlinerBool class.</td></tr></table>&nbsp;
<a href="#onlinerbool-class">Back to Top</a>
...
Provides a string combined from <a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_AttributeName.md">AttributeName</a> of ancestors (<a href="M_Vortex_Connector_ValueTypes_OnlinerBaseType_1_GetParent.md">GetParent()</a>) of this instance and the tail of this instance.
 (Inherited from <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType_1.md">OnlinerBaseType(T)</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerBool_InstanceMaxValue.md">InstanceMaxValue</a></td><td>
Used to satisfy <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType.md">OnlinerBaseType</a> requirements. In case of bool value <a href="P_Vortex_Connector_ValueTypes_OnlinerBool_InstanceMaxValue.md">InstanceMaxValue</a> does not have effect.
 (Overrides <a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_InstanceMaxValue.md">OnlinerBaseType(T).InstanceMaxValue</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerBool_InstanceMinValue.md">InstanceMinValue</a></td><td>
Used to satisfy <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType.md">OnlinerBaseType</a> requirements. In case of bool value <a href="P_Vortex_Connector_ValueTypes_OnlinerBool_InstanceMinValue.md">InstanceMinValue</a> does not have effect.
