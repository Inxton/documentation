...
Defines contract to access shadow value of <a href="https://docs.microsoft.com/dotnet/api/system.uint16" target="_blank">UInt16</a>; UINT type of the PLC.
...
The IShadowUInt type exposes the following members.
...
<a href="#ishadowuint-interface">Back to Top</a>
