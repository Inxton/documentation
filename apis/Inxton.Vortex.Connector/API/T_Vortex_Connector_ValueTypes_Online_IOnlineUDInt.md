...
Defines contract to access online value of <a href="https://docs.microsoft.com/dotnet/api/system.uint32" target="_blank">UInt32</a>; UDINT type of the PLC.
...
The IOnlineUDInt type exposes the following members.
...
<a href="#ionlineudint-interface">Back to Top</a>
