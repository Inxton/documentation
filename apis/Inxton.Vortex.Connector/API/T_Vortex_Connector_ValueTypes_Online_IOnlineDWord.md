...
Defines contract to access online value of <a href="https://docs.microsoft.com/dotnet/api/system.uint32" target="_blank">UInt32</a>; DWORD type of the PLC.
...
The IOnlineDWord type exposes the following members.
...
<a href="#ionlinedword-interface">Back to Top</a>
