# IConnectorFactory.CreateDATE Method (IVortexObject, String, String)
 

Creates <a href="https://docs.microsoft.com/dotnet/api/system.datetime" target="_blank">DateTime</a> tag of a value type DATE;
...
**C#**<br />
``` C#
public abstract OnlinerDate CreateDATE(
