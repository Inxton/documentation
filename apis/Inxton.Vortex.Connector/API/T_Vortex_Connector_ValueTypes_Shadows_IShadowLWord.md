...
Defines contract to access shadow value of <a href="https://docs.microsoft.com/dotnet/api/system.uint64" target="_blank">UInt64</a>; LWORD type of the PLC.
...
The IShadowLWord type exposes the following members.
...
<a href="#ishadowlword-interface">Back to Top</a>
