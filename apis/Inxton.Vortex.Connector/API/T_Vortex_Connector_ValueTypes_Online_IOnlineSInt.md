...
Defines contract to access online value of <a href="https://docs.microsoft.com/dotnet/api/system.sbyte" target="_blank">SByte</a>; SINT type of the PLC.
...
The IOnlineSInt type exposes the following members.
...
<a href="#ionlinesint-interface">Back to Top</a>
