...
Defines contract to access online value of <a href="https://docs.microsoft.com/dotnet/api/system.uint16" target="_blank">UInt16</a>; UINT type of the PLC.
...
The IOnlineUInt type exposes the following members.
...
<a href="#ionlineuint-interface">Back to Top</a>
