# IConnectorFactory.CreateREAL Method (IVortexObject, String, String)
 

Creates <a href="https://docs.microsoft.com/dotnet/api/system.single" target="_blank">Single</a> tag of a value type REAL;
...
**C#**<br />
``` C#
public abstract OnlinerReal CreateREAL(
