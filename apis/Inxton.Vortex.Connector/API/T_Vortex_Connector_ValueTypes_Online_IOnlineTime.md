...
Defines contract to access online value of <a href="https://docs.microsoft.com/dotnet/api/system.timespan" target="_blank">TimeSpan</a>; TIME type of the PLC.
...
The IOnlineTime type exposes the following members.
...
<a href="#ionlinetime-interface">Back to Top</a>
