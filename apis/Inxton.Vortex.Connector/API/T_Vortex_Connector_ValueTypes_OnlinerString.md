...
public class OnlinerString : OnlinerBaseType<string>, 
	IOnlineString, IOnline<string>, IShadowString, IShadow<string>
```

The OnlinerString type exposes the following members.
...
Initializes a new instance of the OnlinerString class.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Connector_ValueTypes_OnlinerString__ctor_1.md">OnlinerString(IVortexObject, String, String)</a></td><td>
Initializes a new instance of the OnlinerString class.</td></tr></table>&nbsp;
<a href="#onlinerstring-class">Back to Top</a>
...
Gets or sets the attribute units.
 (Inherited from <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType_1.md">OnlinerBaseType(T)</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerString_Cyclic.md">Cyclic</a></td><td>
Gets translated and interpolated string of <a href="P_Vortex_Connector_ValueTypes_OnlinerString_Cyclic.md">Cyclic</a> value. Sets <a href="P_Vortex_Connector_ValueTypes_OnlinerString_Cyclic.md">Cyclic</a> value.
 (Overrides <a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_Cyclic.md">OnlinerBaseType(T).Cyclic</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_CyclicReading.md">CyclicReading</a></td><td>
...
Provides a string combined from <a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_AttributeName.md">AttributeName</a> of ancestors (<a href="M_Vortex_Connector_ValueTypes_OnlinerBaseType_1_GetParent.md">GetParent()</a>) of this instance and the tail of this instance.
 (Inherited from <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType_1.md">OnlinerBaseType(T)</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerString_InstanceMaxValue.md">InstanceMaxValue</a></td><td>
Gets the max value for this instance.
 (Overrides <a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_InstanceMaxValue.md">OnlinerBaseType(T).InstanceMaxValue</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerString_InstanceMinValue.md">InstanceMinValue</a></td><td>
...
Gets or sets the tail of the symbol of this tag.
 (Inherited from <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType_1.md">OnlinerBaseType(T)</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerString_Synchron.md">Synchron</a></td><td>
Gets translated and interpolated string of <a href="P_Vortex_Connector_ValueTypes_OnlinerString_Synchron.md">Synchron</a> value. Sets <a href="P_Vortex_Connector_ValueTypes_OnlinerString_Synchron.md">Synchron</a> value.
 (Overrides <a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_Synchron.md">OnlinerBaseType(T).Synchron</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_Translator.md">Translator</a></td><td>
...
Gets tail of the this tag symbol.
 (Inherited from <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType_1.md">OnlinerBaseType(T)</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Vortex_Connector_ValueTypes_OnlinerString_GetSynchron.md">GetSynchron</a></td><td>
Synchron value when overridden. When not overridden <a href="P_Vortex_Connector_ValueTypes_OnlinerString_Cyclic.md">Cyclic</a> value is returned.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="http://msdn2.microsoft.com/en-us/library/dfwy45w9" target="_blank">GetType</a></td><td>
...
NVI should be implemented in derived class. When implemented in derived class provide reading of the <a href="P_Vortex_Connector_ValueTypes_OnlinerBaseType_1_Cyclic.md">Cyclic</a>value for this tag from a stream.
 (Inherited from <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType_1.md">OnlinerBaseType(T)</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Vortex_Connector_ValueTypes_OnlinerString_SetSynchron.md">SetSynchron</a></td><td>
Sets <a href="P_Vortex_Connector_ValueTypes_OnlinerString_Synchron.md">Synchron</a> value when overridden. When not overriden <a href="P_Vortex_Connector_ValueTypes_OnlinerString_Cyclic.md">Cyclic</a> value is set.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Connector_ValueTypes_OnlinerBaseType_1_Subscribe.md">Subscribe</a></td><td>
