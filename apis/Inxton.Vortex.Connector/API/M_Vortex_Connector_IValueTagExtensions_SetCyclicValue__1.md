# IValueTagExtensions.SetCyclicValue(*T*) Method 
...
**C#**<br />
``` C#
public static void SetCyclicValue<T>(
...
#### Parameters
&nbsp;<dl><dt>tag</dt><dd>Type: <a href="T_Vortex_Connector_ValueTypes_OnlinerBaseType.md">Vortex.Connector.ValueTypes.OnlinerBaseType</a><br /></dd><dt>value</dt><dd>Type: *T*<br /></dd></dl>
