...
Defines contract to access online value of <a href="https://docs.microsoft.com/dotnet/api/system.string" target="_blank">String</a>; STRING type of the PLC.
...
The IOnlineString type exposes the following members.
...
<a href="#ionlinestring-interface">Back to Top</a>
