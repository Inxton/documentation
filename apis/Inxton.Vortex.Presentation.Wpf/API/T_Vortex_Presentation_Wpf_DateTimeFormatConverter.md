...
**C#**<br />
``` C#
public class DateTimeFormatConverter : BaseConverter
```

The DateTimeFormatConverter type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Wpf_DateTimeFormatConverter__ctor.md">DateTimeFormatConverter</a></td><td>
Initializes a new instance of the DateTimeFormatConverter class</td></tr></table>&nbsp;
<a href="#datetimeformatconverter-class">Back to Top</a>
