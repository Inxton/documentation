# Renderer.AttachAssemblyToLookUpList Method 
...
**C#**<br />
``` C#
public void AttachAssemblyToLookUpList(
	string assemblyName
)
```
...
#### Parameters
&nbsp;<dl><dt>assemblyName</dt><dd>Type: <a href="https://docs.microsoft.com/dotnet/api/system.string" target="_blank">System.String</a><br /></dd></dl>
