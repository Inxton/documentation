...
**C#**<br />
``` C#
public class ShadowControlTextBoxValue : TextBlock, 
	IComponentConnector
```

The ShadowControlTextBoxValue type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowControl_ShadowControlTextBoxValue__ctor.md">ShadowControlTextBoxValue</a></td><td>
Creates new instance of <a href="T_Vortex_Presentation_Controls_Wpf_ShadowControl_ShadowControlTextBox.md">ShadowControlTextBox</a></td></tr></table>&nbsp;
<a href="#shadowcontroltextboxvalue-class">Back to Top</a>
...
Implements HitTestCore(GeometryHitTestParameters) to supply base element hit testing behavior (returning GeometryHitTestResult).
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowControl_ShadowControlTextBoxValue_InitializeComponent.md">InitializeComponent</a></td><td>
...
#### Reference
<a href="N_Vortex_Presentation_Controls_Wpf_ShadowControl.md">Vortex.Presentation.Controls.Wpf.ShadowControl Namespace</a><br />