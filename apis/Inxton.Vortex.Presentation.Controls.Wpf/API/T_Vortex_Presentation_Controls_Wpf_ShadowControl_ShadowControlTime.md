...
**C#**<br />
``` C#
public class ShadowControlTime : OnlineControlTime
```

The ShadowControlTime type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowControl_ShadowControlTime__ctor.md">ShadowControlTime</a></td><td>
Initializes a new instance of the ShadowControlTime class</td></tr></table>&nbsp;
<a href="#shadowcontroltime-class">Back to Top</a>
