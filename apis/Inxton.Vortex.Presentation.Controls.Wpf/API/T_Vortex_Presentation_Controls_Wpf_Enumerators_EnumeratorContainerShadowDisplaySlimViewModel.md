...
**C#**<br />
``` C#
public class EnumeratorContainerShadowDisplaySlimViewModel : EnumeratorContainerViewModel
```

The EnumeratorContainerShadowDisplaySlimViewModel type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_Enumerators_EnumeratorContainerShadowDisplaySlimViewModel__ctor.md">EnumeratorContainerShadowDisplaySlimViewModel</a></td><td>
Initializes a new instance of the EnumeratorContainerShadowDisplaySlimViewModel class</td></tr></table>&nbsp;
<a href="#enumeratorcontainershadowdisplayslimviewmodel-class">Back to Top</a>
