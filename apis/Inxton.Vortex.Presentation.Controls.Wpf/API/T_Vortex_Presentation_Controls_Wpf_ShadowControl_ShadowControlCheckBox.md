...
**C#**<br />
``` C#
public class ShadowControlCheckBox : CheckBox, 
	IComponentConnector
```

The ShadowControlCheckBox type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowControl_ShadowControlCheckBox__ctor.md">ShadowControlCheckBox</a></td><td>
Creates new instance of ShadowControlCheckBox</td></tr></table>&nbsp;
<a href="#shadowcontrolcheckbox-class">Back to Top</a>
...
Implements HitTestCore(GeometryHitTestParameters) to supply base element hit testing behavior (returning GeometryHitTestResult).
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowControl_ShadowControlCheckBox_InitializeComponent.md">InitializeComponent</a></td><td>
