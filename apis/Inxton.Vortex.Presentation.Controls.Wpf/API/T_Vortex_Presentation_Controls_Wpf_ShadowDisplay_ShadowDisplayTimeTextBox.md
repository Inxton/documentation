# ShadowDisplayTimeTextBox Class
 


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.Windows.Threading.DispatcherObject<br />&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.DependencyObject<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Media.Visual<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.UIElement<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.FrameworkElement<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Controls.TextBlock<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Vortex_Presentation_Controls_Wpf_OnlineDisplay_OnlineDisplayTimeTextBox.md">Vortex.Presentation.Controls.Wpf.OnlineDisplay.OnlineDisplayTimeTextBox</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vortex.Presentation.Controls.Wpf.ShadowDisplay.ShadowDisplayTimeTextBox<br />
...
**C#**<br />
``` C#
public class ShadowDisplayTimeTextBox : OnlineDisplayTimeTextBox
```

The ShadowDisplayTimeTextBox type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowDisplay_ShadowDisplayTimeTextBox__ctor.md">ShadowDisplayTimeTextBox</a></td><td>
Initializes a new instance of the ShadowDisplayTimeTextBox class</td></tr></table>&nbsp;
<a href="#shadowdisplaytimetextbox-class">Back to Top</a>
...
Gets or sets the Brush used to fill the background of content area.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>BaselineOffset</td><td>
Gets or sets the amount by which each line of text is offset from the baseline.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>BindingGroup</td><td>
...
Gets or sets an input source for the bitmap effect that applies directly to the rendered content for this element. This is a dependency property.
 (Inherited from UIElement.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>BreakAfter</td><td>
Gets a LineBreakCondition that indicates how content should break after the current element.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>BreakBefore</td><td>
Gets a LineBreakCondition that indicates how content should break before the current element.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>CacheMode</td><td>
...
Gets a collection of CommandBinding objects associated with this element. A CommandBinding enables command handling for this element, and declares the linkage between a command, its events, and the handlers attached by this element.
 (Inherited from UIElement.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>ContentEnd</td><td>
Gets a TextPointer to the end of content in the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>ContentStart</td><td>
Gets a TextPointer to the beginning of content in the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>ContextMenu</td><td>
...
Gets or sets the preferred top-level font family for the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>FontSize</td><td>
Gets or sets the top-level font size for the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>FontStretch</td><td>
Gets or sets the top-level font-stretching characteristics for the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>FontStyle</td><td>
Gets or sets the top-level font style for the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>FontWeight</td><td>
Gets or sets the top-level font weight for the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>ForceCursor</td><td>
...
Gets or sets the Brush to apply to the text contents of the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>HasAnimatedProperties</td><td>
...
Gets or sets the horizontal alignment characteristics applied to this element when it is composed within a parent element, such as a panel or items control.
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Protected property](media/protproperty.gif "Protected property")</td><td>HostedElementsCore</td><td>
Gets an enumerator that can be used iterate the elements hosted by this TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected property](media/protproperty.gif "Protected property")</td><td>InheritanceBehavior</td><td>
Gets or sets the scope limits for property value inheritance, resource key lookup, and RelativeSource FindAncestor lookup.
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>Inlines</td><td>
Gets an InlineCollection containing the top-level Inline elements that comprise the contents of the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>InputBindings</td><td>
...
Gets or sets a value that declares whether this element can possibly be returned as a hit test result from some portion of its rendered content. This is a dependency property.
 (Inherited from UIElement.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>IsHyphenationEnabled</td><td>
Gets or sets a value that indicates whether automatic hyphenation of words is enabled or disabled.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>IsInitialized</td><td>
...
Gets or sets a graphics transformation that should apply to this element when layout is performed.
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>LineHeight</td><td>
Gets or sets the height of each line of content.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>LineStackingStrategy</td><td>
Gets or sets the mechanism by which a line box is determined for each line of text within the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected property](media/protproperty.gif "Protected property")</td><td>LogicalChildren</td><td>
Gets an enumerator that can iterate the logical children of the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>Margin</td><td>
...
Gets or sets a value that indicates the thickness of padding space between the boundaries of the content area, and the content displayed by a TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>Parent</td><td>
...
Gets a reference to the template parent of this element. This property is not relevant if the element was not created through a template.
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>Text</td><td>
Gets or sets the text contents of a TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>TextAlignment</td><td>
Gets or sets a value that indicates the horizontal alignment of text content.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>TextDecorations</td><td>
Gets or sets a TextDecorationCollection that contains the effects to apply to the text of a TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>TextEffects</td><td>
Gets or sets the effects to apply to the text content in this element.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>TextTrimming</td><td>
Gets or sets the text trimming behavior to employ when content overflows the content area.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>TextWrapping</td><td>
Gets or sets how the TextBlock should wrap text.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>ToolTip</td><td>
...
Gets the collection of triggers established directly on this element, or in child elements.
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>Typography</td><td>
Gets the currently effective typography variations for the contents of this element.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>Uid</td><td>
...
Gets the number of Visual children hosted by the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected property](media/protproperty.gif "Protected property")</td><td>VisualClearTypeHint</td><td>
...
Positions child elements and determines a size for the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>BeginAnimation(DependencyProperty, AnimationTimeline)</td><td>
...
Creates a specialized enumerator for determining which dependency properties have locally set values on this DependencyObject.
 (Inherited from DependencyObject.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>GetPositionFromPoint</td><td>
Returns a TextPointer to the position closest to a specified Point.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>GetRectanglesCore</td><td>
Returns a read-only collection of bounding rectangles for a specified ContentElement.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>GetTemplateChild</td><td>
...
Returns the Visual child at a specified index.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>HitTestCore(PointHitTestParameters)</td><td>
Returns a PointHitTestResult for specified PointHitTestParameters.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>HitTestCore(GeometryHitTestParameters)</td><td>
Implements HitTestCore(GeometryHitTestParameters) to supply base element hit testing behavior (returning GeometryHitTestResult).
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_OnlineDisplay_OnlineDisplayTimeTextBox_InitializeComponent.md">InitializeComponent</a></td><td>
InitializeComponent
 (Inherited from <a href="T_Vortex_Presentation_Controls_Wpf_OnlineDisplay_OnlineDisplayTimeTextBox.md">OnlineDisplayTimeTextBox</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>InputHitTest</td><td>
Returns the input element within the current element that is at the specified coordinates, relative to the current element's origin.
 (Inherited from UIElement.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>InputHitTestCore</td><td>
Returns the IInputElement at a specified Point within the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>InvalidateArrange</td><td>
...
Called to re-measure the TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>MemberwiseClone</td><td>
...
Supports layout behavior when a child element is resized.
 (Inherited from UIElement.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>OnChildDesiredSizeChangedCore</td><td>
Called when a child element deriving from UIElement changes its DesiredSize.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>OnContextMenuClosing</td><td>
...
Creates and returns an AutomationPeer object for this TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>OnDpiChanged</td><td>
...
Called when the value one or more hosted dependency properties changes.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>OnQueryContinueDrag</td><td>
...
Renders the contents of a TextBlock.
 (Inherited from TextBlock.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td>OnRenderSizeChanged</td><td>
...
#### Reference
<a href="N_Vortex_Presentation_Controls_Wpf_ShadowDisplay.md">Vortex.Presentation.Controls.Wpf.ShadowDisplay Namespace</a><br />