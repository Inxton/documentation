...
**C#**<br />
``` C#
public class OnlineControlTextBoxValue : TextBlock, 
	IComponentConnector
```

The OnlineControlTextBoxValue type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_OnlineControl_OnlineControlTextBoxValue__ctor.md">OnlineControlTextBoxValue</a></td><td>
Creates new instance of OnlineControlTextBoxValue</td></tr></table>&nbsp;
<a href="#onlinecontroltextboxvalue-class">Back to Top</a>
...
Implements HitTestCore(GeometryHitTestParameters) to supply base element hit testing behavior (returning GeometryHitTestResult).
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_OnlineControl_OnlineControlTextBoxValue_InitializeComponent.md">InitializeComponent</a></td><td>
...
#### Reference
<a href="N_Vortex_Presentation_Controls_Wpf_OnlineControl.md">Vortex.Presentation.Controls.Wpf.OnlineControl Namespace</a><br />