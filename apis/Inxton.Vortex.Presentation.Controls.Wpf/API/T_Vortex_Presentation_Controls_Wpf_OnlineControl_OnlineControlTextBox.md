...
**C#**<br />
``` C#
public class OnlineControlTextBox : TextBlock, 
	IComponentConnector
```

The OnlineControlTextBox type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_OnlineControl_OnlineControlTextBox__ctor.md">OnlineControlTextBox</a></td><td>
Creates new instance of OnlineControlTextBox</td></tr></table>&nbsp;
<a href="#onlinecontroltextbox-class">Back to Top</a>
...
Implements HitTestCore(GeometryHitTestParameters) to supply base element hit testing behavior (returning GeometryHitTestResult).
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_OnlineControl_OnlineControlTextBox_InitializeComponent.md">InitializeComponent</a></td><td>
