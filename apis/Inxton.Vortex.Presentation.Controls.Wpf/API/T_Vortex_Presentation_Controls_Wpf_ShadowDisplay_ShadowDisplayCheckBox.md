...
**C#**<br />
``` C#
public class ShadowDisplayCheckBox : CheckBox, 
	IComponentConnector
```

The ShadowDisplayCheckBox type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowDisplay_ShadowDisplayCheckBox__ctor.md">ShadowDisplayCheckBox</a></td><td>
Creates new instance of ShadowDisplayCheckBox</td></tr></table>&nbsp;
<a href="#shadowdisplaycheckbox-class">Back to Top</a>
...
Implements HitTestCore(GeometryHitTestParameters) to supply base element hit testing behavior (returning GeometryHitTestResult).
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowDisplay_ShadowDisplayCheckBox_InitializeComponent.md">InitializeComponent</a></td><td>
