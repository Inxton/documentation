...
#### Parameters
&nbsp;<dl><dt>attribute</dt><dd>Type: EnumeratorDiscriminatorAttribute<br />\[Missing <param name="attribute"/> documentation for "M:Vortex.Presentation.Controls.Wpf.Enumerators.EnumToIntConverter.#ctor(Vortex.Connector.EnumeratorDiscriminatorAttribute)"\]</dd></dl>
