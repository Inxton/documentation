...
**C#**<br />
``` C#
public class ShadowControlTimeTextBox : TimeTextBoxBaseBox, 
	IComponentConnector
```

The ShadowControlTimeTextBox type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowControl_ShadowControlTimeTextBox__ctor.md">ShadowControlTimeTextBox</a></td><td>
Creates new instance of ShadowControlTimeTextBox</td></tr></table>&nbsp;
<a href="#shadowcontroltimetextbox-class">Back to Top</a>
...
Gets or sets a value that indicates whether layout rounding should be applied to this element's size and position during layout.
 (Inherited from FrameworkElement.)</td></tr><tr><td>![Protected property](media/protproperty.gif "Protected property")</td><td><a href="P_Vortex_Presentation_Controls_Wpf_ShadowControl_ShadowControlTimeTextBox_ValueTextBox.md">ValueTextBox</a></td><td> (Overrides <a href="P_Vortex_Presentation_Controls_Wpf_TimeTextBoxBaseBox_ValueTextBox.md">TimeTextBoxBaseBox.ValueTextBox</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td>VerticalAlignment</td><td>
...
Implements HitTestCore(GeometryHitTestParameters) to supply base element hit testing behavior (returning GeometryHitTestResult).
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowControl_ShadowControlTimeTextBox_InitializeComponent.md">InitializeComponent</a></td><td>
