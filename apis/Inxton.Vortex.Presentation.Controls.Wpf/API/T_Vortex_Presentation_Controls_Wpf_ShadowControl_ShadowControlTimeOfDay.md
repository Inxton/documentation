...
**C#**<br />
``` C#
public class ShadowControlTimeOfDay : OnlineControlTimeOfDay
```

The ShadowControlTimeOfDay type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowControl_ShadowControlTimeOfDay__ctor.md">ShadowControlTimeOfDay</a></td><td>
Initializes a new instance of the ShadowControlTimeOfDay class</td></tr></table>&nbsp;
<a href="#shadowcontroltimeofday-class">Back to Top</a>
