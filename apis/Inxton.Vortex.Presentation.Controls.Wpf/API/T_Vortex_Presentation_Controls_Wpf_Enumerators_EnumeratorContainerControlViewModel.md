...
**C#**<br />
``` C#
public class EnumeratorContainerControlViewModel : EnumeratorContainerViewModel
```

The EnumeratorContainerControlViewModel type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_Enumerators_EnumeratorContainerControlViewModel__ctor.md">EnumeratorContainerControlViewModel</a></td><td>
Initializes a new instance of the EnumeratorContainerControlViewModel class</td></tr></table>&nbsp;
<a href="#enumeratorcontainercontrolviewmodel-class">Back to Top</a>
