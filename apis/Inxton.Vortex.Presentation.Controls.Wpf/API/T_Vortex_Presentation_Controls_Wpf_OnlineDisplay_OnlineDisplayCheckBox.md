...
**C#**<br />
``` C#
public class OnlineDisplayCheckBox : CheckBox, 
	IComponentConnector
```

The OnlineDisplayCheckBox type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_OnlineDisplay_OnlineDisplayCheckBox__ctor.md">OnlineDisplayCheckBox</a></td><td>
Creates new instance of OnlineDisplayCheckBox</td></tr></table>&nbsp;
<a href="#onlinedisplaycheckbox-class">Back to Top</a>
...
Implements HitTestCore(GeometryHitTestParameters) to supply base element hit testing behavior (returning GeometryHitTestResult).
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_OnlineDisplay_OnlineDisplayCheckBox_InitializeComponent.md">InitializeComponent</a></td><td>
