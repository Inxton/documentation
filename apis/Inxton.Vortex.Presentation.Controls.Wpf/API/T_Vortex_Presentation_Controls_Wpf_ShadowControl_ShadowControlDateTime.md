...
**C#**<br />
``` C#
public class ShadowControlDateTime : OnlineControlDateTime
```

The ShadowControlDateTime type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_ShadowControl_ShadowControlDateTime__ctor.md">ShadowControlDateTime</a></td><td>
Initializes a new instance of the ShadowControlDateTime class</td></tr></table>&nbsp;
<a href="#shadowcontroldatetime-class">Back to Top</a>
...
Implements HitTestCore(GeometryHitTestParameters) to supply base element hit testing behavior (returning GeometryHitTestResult).
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_OnlineControl_OnlineControlDateTime_InitializeComponent.md">InitializeComponent</a></td><td>
InitializeComponent
 (Inherited from <a href="T_Vortex_Presentation_Controls_Wpf_OnlineControl_OnlineControlDateTime.md">OnlineControlDateTime</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>InputHitTest</td><td>
