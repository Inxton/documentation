...
**C#**<br />
``` C#
public class OnlineDisplayTextBoxValue : TextBlock, 
	IComponentConnector
```

The OnlineDisplayTextBoxValue type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_OnlineDisplay_OnlineDisplayTextBoxValue__ctor.md">OnlineDisplayTextBoxValue</a></td><td>
Creates new instance of <a href="T_Vortex_Presentation_Controls_Wpf_OnlineDisplay_OnlineDisplayTextBox.md">OnlineDisplayTextBox</a></td></tr></table>&nbsp;
<a href="#onlinedisplaytextboxvalue-class">Back to Top</a>
...
Implements HitTestCore(GeometryHitTestParameters) to supply base element hit testing behavior (returning GeometryHitTestResult).
 (Inherited from UIElement.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_OnlineDisplay_OnlineDisplayTextBoxValue_InitializeComponent.md">InitializeComponent</a></td><td>
