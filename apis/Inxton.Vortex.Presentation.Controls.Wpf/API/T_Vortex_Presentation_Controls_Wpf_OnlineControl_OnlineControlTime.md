...
**C#**<br />
``` C#
public class OnlineControlTime : OnlineControlTimeOfDay
```

The OnlineControlTime type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_OnlineControl_OnlineControlTime__ctor.md">OnlineControlTime</a></td><td>
Initializes a new instance of the OnlineControlTime class</td></tr></table>&nbsp;
<a href="#onlinecontroltime-class">Back to Top</a>
