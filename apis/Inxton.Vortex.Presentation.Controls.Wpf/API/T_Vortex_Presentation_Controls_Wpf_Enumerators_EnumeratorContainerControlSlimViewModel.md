...
**C#**<br />
``` C#
public class EnumeratorContainerControlSlimViewModel : EnumeratorContainerViewModel
```

The EnumeratorContainerControlSlimViewModel type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_Enumerators_EnumeratorContainerControlSlimViewModel__ctor.md">EnumeratorContainerControlSlimViewModel</a></td><td>
Initializes a new instance of the EnumeratorContainerControlSlimViewModel class</td></tr></table>&nbsp;
<a href="#enumeratorcontainercontrolslimviewmodel-class">Back to Top</a>
