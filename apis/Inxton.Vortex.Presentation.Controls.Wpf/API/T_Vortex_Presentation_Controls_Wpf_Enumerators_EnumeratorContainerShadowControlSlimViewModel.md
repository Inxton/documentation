...
**C#**<br />
``` C#
public class EnumeratorContainerShadowControlSlimViewModel : EnumeratorContainerViewModel
```

The EnumeratorContainerShadowControlSlimViewModel type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Vortex_Presentation_Controls_Wpf_Enumerators_EnumeratorContainerShadowControlSlimViewModel__ctor.md">EnumeratorContainerShadowControlSlimViewModel</a></td><td>
Initializes a new instance of the EnumeratorContainerShadowControlSlimViewModel class</td></tr></table>&nbsp;
<a href="#enumeratorcontainershadowcontrolslimviewmodel-class">Back to Top</a>
